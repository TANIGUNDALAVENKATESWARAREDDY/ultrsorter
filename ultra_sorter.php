...
$feature_details = executeSelect('features',array(),array('content_type' => 'ultra_sorter'));
$product_table = executeSelect('product_table',array(),array('product_name' => 'ultra_sorter'));                           

?>
<!-- Page Header Start -->
<div class='container-fluid gain-sorter py-1 mb-5 mt-3 bg-light'>
    <div class='container py-1'>
        <h1 class='display-3 text-white mb-2 animated slideInDown tech font-24 text-upper'>Ultra Sorter</h1>
        <nav aria-label='breadcrumb animated slideInDown'>
            <ol class='breadcrumb'>
                ...
                <li class='breadcrumb-item text-black active' aria-current='page'>Ultra Sorter</li>
            </ol>
        </nav>
    </div>
</div>
...
</li><li>Ultra wide resolution Tri_chromatic (RGB/Full Color) with near human Eye vision
...
</li><li>Avaiable with <strong>84-168-252-336-420-504-588</strong> channels.
...
performance throughout the life of machine.
            ...
            <div class='col-lg-6 pe-lg-0' style='min-height: 400px;'>
                <div class='position-relative h-100'>
                    <img class='position-absolute img-fluid w-100 h-100 bg-white' src='zpress/./data/rG47LfOs1l/Ultra-S3.jpg' style='' alt=''>
                </div>
            </div>
        </div>
    </div>
